...
public class MediaPlayerManager {
    ...
    public void playSong(Context context, int songResource, String songTitle, String artistName, int albumCoverResource) {
        // Check if MediaPlayer is initialized and in a valid state
        if (mediaPlayer != null) {
            try {
        ...
        // Set up new MediaPlayer with the new song
    ...
    public int getCurrentSongResource() {
        return currentSongResource; // Return the current song's resource ID
    }
